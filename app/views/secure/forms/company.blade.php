...
<?php
$pageName = TextProcessor::process('New {%Company.singular%}');
...
@section('content')
    <div class='col-sm-11' style="margin:50px">
        ...
        <?php
        $placeholder = TextProcessor::process('{%Company.singular%} Name');
        ?>

        {{ Form::text('companyName','',array('placeholder'=>$placeholder,'class'=>'col-sm-12 form-control','id'=>'companyName')) }}
        ...
        <div class="row" style="margin-top:10px">
            ...
            <div class="col-sm-5">
                <div class="row">
                    <button type="submit" class="btn btn-primary" id="saveButton">{{TextProcessor::display('Save {%Company.singular%}')}}</button>
                </div>
            </div>
        </div>
