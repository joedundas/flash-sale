<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active">
        <a href="/dashboard" class="navButton">
    ...
    <li>
    <a href="/companies" class="navButton">
    <i class="fa fa-hourglass"></i> {{TextProcessor::display('{%Company.plural%}')}}<span></span>
    <span class="pull-right-container">
    ...
    <li>
        <a href="/campaigns" class="navButton">
            <i class="fa fa-hourglass"></i> {{TextProcessor::display('{%Campaign.plural%}')}}<span></span>
            <span class="pull-right-container">
    {{--<small class="label pull-right bg-red">3</small>--}}
                {{--<small class="label pull-right bg-blue">17</small>--}}
    </span>
    ...
    {{--<li>--}}
        {{--<a href="/calendar" class="navButton">--}}
